...
describe('[Bin Utils] generateDocs', () => {
  ...
  it(
    'should throw error when doc file does not exist',
    async () => {
      await expect(
        Utils.generateDocs({
          dependencyFlowchart,
  ...
  it(
    'should throw error when the starter marker is missing',
    async () => {
      await expect(
        Utils.generateDocs({
          dependencyFlowchart,
  ...
  it(
    'should throw error when the end marker is missing',
    async () => {
      await expect(
        Utils.generateDocs({
          dependencyFlowchart,
  ...
  it(
    'should skip formatting if Prettier or ESLint fail',
    async () => {
      try {
        vi.resetModules();
